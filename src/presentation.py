...
import os
def generatePDF(path,path2,path3,path4, font, yea,typ):
    if typ=='s':
        ...
        c.drawRightString(ancho-30, 20, "Javier Molins Jiménez")
        c.setFont("{}-Bold".format(font), 20)
        c.drawCentredString(round(ancho/2), alto-80, "Suicides between {}-2014 - Extended inform".format(yea))
        c.drawImage("../presentacion/logo-ironhack-madrid.jpg", 0, alto-100, width=100, height=100)
        c.drawImage("../presentacion/descarga.png", ancho-100, alto-100, width=75, height=75)
        x=0
        y=alto-100
        ...
        c.drawRightString(ancho-30, 20, "Javier Molins Jiménez")
        c.setFont("{}-Bold".format(font), 20)
        c.drawCentredString(round(ancho/2), alto-80, "Suicides between {}-2014 - Short inform".format(yea))
        c.drawImage("../presentacion/logo-ironhack-madrid.jpg", 0, alto-100, width=100, height=100)
        c.drawImage("../presentacion/descarga.png", ancho-100, alto-100, width=75, height=75)
        x=0
        y=alto-100
        ...
        print('Unknown type of inform')
    return archivo


def pdf(p,p2,p3,p4,f,y,t):
    url = generatePDF(p,p2,p3,p4,f,y,t)
    return url